            ...
            {projects.map((project: Project) => (
              <Link
                ...
                <div className= "flow-root">
                  <div className ="float-left ml-4 mt-4 font-semibold text-white"> {project.name} </div>
                  <div className ="float-right mr-4 mt-4 font-semibold text-indigo-300"> {project.date} </div>
                </div>
                <div className="mt-3 ml-4 mr-4 mb-4 text-sm text-white"> {description(project)} </div>
              </Link>
            ))}
          </div>
        </div>
